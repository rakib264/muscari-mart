...
export async function getEmailSettings(): Promise<EmailSettings> {
  ...
  return {
    siteName: dbSettings?.siteName || process.env.NEXT_PUBLIC_SITE_NAME || 'Muscari Mart',
    ...
    contactEmail: dbSettings?.contactEmail || process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'info.wellrise@gmail.com',
