        ...
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            <Button
              ...
              role="combobox"
              aria-expanded={open}
              className="w-full justify-between h-auto min-h-[40px] p-3 text-gray-700 hover:text-white"
              disabled={disabled}
            >
            ...
            <Command shouldFilter={false}>
              <div className="flex items-center border-b px-3">
                ...
                <Input
                  ...
                  className="flex h-11 w-full border-0 bg-transparent py-3 text-sm outline-none placeholder:text-gray-500 disabled:cursor-not-allowed disabled:opacity-50"
                />
              </div>
              <CommandEmpty>
                {loading ? (
