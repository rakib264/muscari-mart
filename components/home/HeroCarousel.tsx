              ...
              >
                ...
                {currentBanner.subtitle && (
                  ...
                  >
                    ...
                    <Caption weight="light" spacing="widest" className="text-white/90 uppercase">
                      {currentBanner.subtitle}
                    </Caption>
                ...
                >
                  <Display size="sm" weight="light" spacing="wide" color="white" leading="tight">
                    {currentBanner.title}
                  </Display>
                </motion.div>
                  ...
                  >
                    ...
                    {currentBanner.subtitle && (
                      ...
                      >
                        ...
                        <Caption weight="light" spacing="wider" className="text-white/90 uppercase border-l border-white/30 pl-3">
                          {currentBanner.subtitle}
                        </Caption>
                      </motion.div>
                    )}
                    ...
                    <motion.div
                      ...
                      transition={{ delay: 0.3 }}
                    >
                      <Display size="xs" weight="thin" spacing="tight" color="white" leading="tight">
                        {currentBanner.title}
                      </Display>
                    </motion.div>
                    ...
                    {currentBanner.description && (
                      ...
                      >
                        <Text size="lg" weight="light" leading="relaxed" className="text-white/80 max-w-md">
                          {currentBanner.description}
                        </Text>
                      </motion.div>
                    )}
                    ...
                    >
                      ...
                      <Caption spacing="wide" className="text-white/70">Trusted by 50,000+ customers</Caption>
                    </motion.div>
                  </motion.div>
                </AnimatePresence>
              ) : (
