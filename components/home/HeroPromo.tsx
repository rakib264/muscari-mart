      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="w-full">
          ...
          >
            ...
            <Display size="xs" weight="bold" leading="tight" className="mb-6">
            ...
            <Text size="xl" leading="relaxed" className="text-purple-100 mb-8 max-w-4xl mx-auto">
              ...
              <Link href="/categories/women">
                <div className="w-full h-32 md:h-40 lg:h-48 bg-gradient-to-br from-pink-500/40 to-rose-500/40 rounded-2xl backdrop-blur-sm border border-white/30 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:from-pink-500/50 group-hover:to-rose-500/50">
                  ...
                  <div className="relative h-full flex flex-col items-center justify-center p-4">
                    ...
                    <Heading level={6} weight="bold" color="white" className="text-center group-hover:text-pink-100 transition-colors duration-300">Women's</Heading>
                    <Caption className="text-pink-200 text-center group-hover:text-pink-100 transition-colors duration-300">Elegant</Caption>
                  </div>
                </div>
              </Link>
            </motion.div>
              ...
              <Link href="/categories/men">
                <div className="w-full h-32 md:h-40 lg:h-48 bg-gradient-to-br from-blue-500/40 to-indigo-500/40 rounded-2xl backdrop-blur-sm border border-white/30 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:from-blue-500/50 group-hover:to-indigo-500/50">
                  ...
                  <div className="relative h-full flex flex-col items-center justify-center p-4">
                    ...
                    <Heading level={6} weight="bold" color="white" className="text-center group-hover:text-blue-100 transition-colors duration-300">Men's</Heading>
                    <Caption className="text-blue-200 text-center group-hover:text-blue-100 transition-colors duration-300">Sharp</Caption>
                  </div>
                </div>
              </Link>
            </motion.div>
              ...
              <Link href="/categories/boys">
                <div className="w-full h-32 md:h-40 lg:h-48 bg-gradient-to-br from-green-500/40 to-emerald-500/40 rounded-2xl backdrop-blur-sm border border-white/30 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:from-green-500/50 group-hover:to-emerald-500/50">
                  ...
                  <div className="relative h-full flex flex-col items-center justify-center p-4">
                    ...
                    <Heading level={6} weight="bold" color="white" className="text-center group-hover:text-green-100 transition-colors duration-300">Boys</Heading>
                    <Caption className="text-green-200 text-center group-hover:text-green-100 transition-colors duration-300">Cool</Caption>
                  </div>
                </div>
              </Link>
            </motion.div>
              ...
              <Link href="/categories/girls">
                <div className="w-full h-32 md:h-40 lg:h-48 bg-gradient-to-br from-purple-500/40 to-pink-500/40 rounded-2xl backdrop-blur-sm border border-white/30 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:from-purple-500/50 group-hover:to-pink-500/50">
                  ...
                  <div className="relative h-full flex flex-col items-center justify-center p-4">
                    ...
                    <Heading level={6} weight="bold" color="white" className="text-center group-hover:text-purple-100 transition-colors duration-300">Girls</Heading>
                    <Caption className="text-purple-200 text-center group-hover:text-purple-100 transition-colors duration-300">Cute</Caption>
                  </div>
                </div>
              </Link>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <Heading level={3} weight="bold" className="mb-1 bg-gradient-to-r from-pink-300 to-pink-200 bg-clip-text text-transparent">10K+</Heading>
              <Caption className="text-purple-200 group-hover:text-purple-100 transition-colors duration-300">Happy Customers</Caption>
            </motion.div>
            ...
            >
              ...
              <Heading level={3} weight="bold" className="mb-1 bg-gradient-to-r from-yellow-300 to-yellow-200 bg-clip-text text-transparent">4.8</Heading>
              <Caption className="text-purple-200 group-hover:text-purple-100 transition-colors duration-300">Average Rating</Caption>
            </motion.div>
            ...
            >
              ...
              <Heading level={3} weight="bold" className="mb-1 bg-gradient-to-r from-purple-300 to-purple-200 bg-clip-text text-transparent">500+</Heading>
              <Caption className="text-purple-200 group-hover:text-purple-100 transition-colors duration-300">Products</Caption>
            </motion.div>
          </motion.div>
        </div>
      </div>
