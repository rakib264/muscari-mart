...
export default function Newsletter() {
  ...
  return (
    <section className="py-16 lg:py-24 bg-gradient-to-br from-primary to-orange-400 text-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <Heading level={2} weight="bold" color="white" className="mb-4">
              Stay Updated with {siteName}
            </Heading>

            <Text size="xl" className="text-blue-100 mb-8 max-w-2xl mx-auto">
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <Caption className="text-blue-200">Weekly Deals & Offers</Caption>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-yellow-400 rounded-full" />
              <Caption className="text-blue-200">New Product Launches</Caption>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-pink-400 rounded-full" />
              <Caption className="text-blue-200">Exclusive Member Benefits</Caption>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-6"
          >
            <Caption className="text-blue-200">
