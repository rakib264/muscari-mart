      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6">
            ...
            <Display size="md" weight="bold" gradient="warm" className="text-center">
              Hot Deals & Events
            </Display>
            <motion.div
              animate={{ 
          ...
          <Text size="xl" leading="relaxed" className="text-gray-600 max-w-3xl mx-auto mb-6 sm:mb-8 px-4">
