      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-indigo-50/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <Heading level={2} gradient="primary" className="mb-4">
              Discover Categories
            </Heading>
            <Text size="lg" className="text-gray-600">Loading amazing categories for you...</Text>
          </div>
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-indigo-50/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-100 to-violet-100 rounded-full mb-6">
            <Sparkles className="w-4 h-4" />
            <Caption weight="medium" className="text-indigo-700">Curated Collections</Caption>
          </div>
          <Display size="lg" gradient="primary" className="mb-6">
            Discover Categories
          </Display>
              ...
              >
                <Link href={`/categories/${category.slug}`}>
                  ...
                  >
                    ...
                    <Heading level={6} weight="semibold" className="text-gray-900 group-hover:text-indigo-600 transition-colors duration-200">
                      {category.name}
                    </Heading>
                  ...
                  return (
                    <>
                      <div className="text-center mb-6">
                        <Heading level={4} weight="bold" className="text-gray-900 mb-2">{category.name}</Heading>
                        <Caption className="text-gray-500">Explore subcategories</Caption>
                      </div>
                        ...
                        {category.children.map((child) => (
                          ...
                          >
                            ...
                            <div className="text-center">
                              <Text size="sm" weight="medium" className="text-gray-900 group-hover:text-indigo-600 transition-colors break-words">
                                {child.name}
                              </Text>
                              {child.productCount && (
                                <Caption className="text-gray-500 mt-1">
              ...
              >
                <div className="flex items-center justify-between p-4">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <Heading level={5} weight="semibold" className="text-gray-900">
                        {category.name}
                      </Heading>
                      {category.productCount && (
                      ...
                      <div className="p-4 space-y-2">
                        {category.children.map((child) => (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <Text size="md" weight="medium" className="text-gray-900 group-hover:text-indigo-600 transition-colors">
                                {child.name}
                              </Text>
                              {child.description && (
                                <Text size="sm" className="text-gray-500 line-clamp-1">
                                  {child.description}
                                </Text>
                              )}
                              {child.productCount && (
        ...
        >
          <div className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <Heading level={3} weight="bold" color="white" className="mb-4">
