      ...
      <div className="container mx-auto px-4 py-4 md:py-8 mt-16 md:mt-20 mb-20 md:mb-0 relative z-10">
        ...
        >
          ...
          <p className="text-purple-100 text-center mb-6">
            Exclusive pieces in limited quantities. Don't miss out on these rare
            finds before they're gone forever
          </p>
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          <div className="flex-1">
            <div className="mb-4 flex items-center justify-between">
              <p className="text-purple-100">
                Showing {products.length} of {pagination.total} limited edition
                products
              </p>
              {hasActiveFilters && (
              ...
              <AnimatePresence>
                {loading
                  ? [...Array(12)].map((_, index) => (
                      <div
                        key={index}
                        className="animate-pulse bg-white/20 h-80 rounded-lg"
                      />
                    ))
                          ...
                          {viewMode === "grid" ? (
                            ...
                            <Card className="group border-0 bg-transparent shadow-none">
                              <Link href={`/products/${product.slug}`}>
                                <div className="flex gap-4 bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 border border-white/20">
                                  <div className="relative w-48 h-48 flex-shrink-0 bg-white/5">
                                    <img
            ...
            {!loading && products.length === 0 && (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-purple-100 mb-2">
                  No Limited Edition Items Found
                </h3>
                    ...
                    return (
                      ...
                      >
                        {viewMode === "grid" ? (
                          ...
                          <Card className="group border-0 bg-transparent shadow-none">
                            <Link href={`/products/${product.slug}`}>
                              <div className="flex gap-3 bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden shadow-sm border border-white/20">
                                <div className="relative w-28 h-28 flex-shrink-0 bg-white/5">
                                  <img
                                    src={product.thumbnailImage}
                                    alt={product.name}
                                    className="w-full h-full object-cover"
