        ...
        <div className="hidden lg:flex gap-8">
          ...
          <div className="flex-1">
            ...
            <motion.div
              ...
              className={`grid ${
                viewMode === 'grid' 
                  ? 'grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6' 
                  : 'grid-cols-1 gap-6'
                          ...
                          <Link href={`/products/${product.slug}`}>
                            ...
                            <div className="relative bg-white rounded-lg overflow-hidden aspect-square">
                              ...
                              <button
                                ...
                                className="absolute top-3 right-3 w-9 h-9 bg-white rounded-full flex items-center justify-center shadow-md hover:scale-110 transition-transform duration-200 z-10"
                              >
                                <Heart 
                                  size={18} 
                    ...
                    {viewMode === 'grid' ? (
                      ...
                      <div className="space-y-2">
                        <Link href={`/products/${product.slug}`}>
                          ...
                          <div className="relative bg-white rounded-lg overflow-hidden aspect-square">
                            ...
                            <button
                              ...
                              className="absolute top-2 right-2 w-7 h-7 bg-white rounded-full flex items-center justify-center shadow-md z-10"
                            >
                              <Heart 
                                size={14} 
                                className={wishlistItems.some(item => item.id === product._id) ? 'fill-current text-red-500' : 'text-gray-700'} 
                        ...
                        <div className="space-y-1.5 px-0.5">
                          <Link href={`/products/${product.slug}`}>
                            {/* Category */}
                            <p className="text-[10px] xs:text-xs text-gray-500 font-medium uppercase tracking-wide mb-1">
                              {product.category?.name || 'New Arrival'}
                            </p>

                            {/* Product Name */}
                            <h3 className="text-xs xs:text-sm font-medium text-gray-900 line-clamp-2 mb-1.5 leading-tight">
                              {product.name}
                            </h3>
                          </Link>
                          ...
                          <div className="flex items-center justify-between gap-1.5">
                            <div className="flex flex-col min-w-0">
                              ...
                              {product?.comparePrice !== 0 && product?.comparePrice !== undefined && product?.comparePrice > product?.price && (
                                <span className="text-[10px] xs:text-xs text-gray-500 line-through truncate">
                                  {formatPrice(product.comparePrice)}
                                </span>
                              )}
                            </div>
