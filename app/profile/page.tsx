...
import { Camera, Heart, LogOut, RotateCcw, ShoppingBag, Trash2, Upload, User } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-secondary-50 to-primary-100">
      ...
      <div className="container mx-auto px-4 py-6 md:py-8 mt-16 md:mt-20 mb-20 md:mb-0">
        {/* Profile Header */}
        <div className="mb-8">
          <h1 className="typography-hero-title text-gradient-elegant mb-2">
            My Profile
          </h1>
          <p className="typography-section-subtitle text-hierarchy-subtitle">Manage your account settings and preferences</p>
        </div>
