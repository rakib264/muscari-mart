        ...
        <div className="mb-6">
          ...
          {items.length > 0 && (
            <div className="flex items-center space-x-2 typography-caption text-hierarchy-caption">
              ...
              <span className="text-hierarchy-body">Cart</span>
              <span className="text-hierarchy-caption">→</span>
              <span className="text-hierarchy-caption">Checkout</span>
              <span className="text-hierarchy-caption">→</span>
              <span className="text-hierarchy-caption">Payment</span>
            </div>
          )}
        </div>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center space-x-2">
                                <span className="typography-micro text-hierarchy-label font-medium">Qty:</span>
                                <div className="flex items-center border border-gray-300 rounded-md">
                                  ...
                                  <div className="w-8 h-6 flex items-center justify-center border-x border-gray-300 typography-micro font-semibold text-hierarchy-title bg-white">
                                    {item.quantity}
                                  </div>
                                  <Button
                                    variant="ghost"
