              ...
              {loading ? (
                viewMode === 'list' ? (
                  <div className="space-y-4">
                    {[...Array(6)].map((_, i) => (
                      <div key={i} className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-lg animate-pulse">
                        <div className="flex flex-col md:flex-row">
                          <div className="w-full md:w-48 h-48 md:h-32 bg-gray-200"></div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                    {[...Array(12)].map((_, i) => (
                      <div key={i} className="bg-white border-2 border-primary-100 rounded-2xl overflow-hidden animate-pulse">
                        <div className="bg-gray-200 h-28 sm:h-36 md:h-40 lg:h-44"></div>
                        <div className="p-2 sm:p-3 md:p-4 space-y-2 sm:space-y-3">
                          ...
                          <div className="flex items-center justify-between pt-2">
                            ...
                            <div className="h-8 w-16 sm:w-20 bg-gray-200 rounded-lg sm:rounded-full"></div>
                          </div>
                        </div>
                      </div>
                    ))}
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      <div onClick={(e) => {
                                        ...
                                        <AddToCartButton
                                          ...
                                          text="Add to Cart"
                                          className="px-6 py-2 rounded-xl shadow-sm hover:shadow-md"
                                        />
                                      </div>
                                    </div>
                                  </div>
