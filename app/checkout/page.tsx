        ...
        <div className="mb-6">
          ...
          <div className="block md:hidden">
            <div className="flex items-center justify-between mb-3">
              <h2 className="typography-card-title text-hierarchy-title">Step {currentStep} of {steps.length}</h2>
              <span className="typography-caption text-hierarchy-subtitle">
            ...
            {steps.map((step, index) => (
              <div key={step.number} className="flex items-center">
                <div className={`flex items-center space-x-3 ${
                  ...
                  <span className="typography-label text-hierarchy-title">{step.title}</span>
                </div>
                  ...
                  <Card className="bg-white shadow-sm border border-gray-200">
                    <CardHeader className="pb-4">
                      <CardTitle className="flex items-center space-x-3 text-gray-900">
                        ...
                        <span className="typography-section-title">Billing Information</span>
                      </CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <Label htmlFor="firstName" className="typography-label text-hierarchy-label">First Name *</Label>
                          <Input
                            id="firstName"
                          ...
                          {displayErrors.firstName && (
                            <p className="text-destructive-500 typography-micro mt-1 p-2">{displayErrors.firstName}</p>
                          )}
                        </div>
                        <div>
