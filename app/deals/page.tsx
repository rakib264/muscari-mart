    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-4 md:py-8 mt-16 md:mt-20 mb-20 md:mb-0">
        ...
        >
          ...
          <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Hot Deals & Event Specials</h1>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-6 text-white text-center mb-12"
        >
          <div className="flex items-center justify-center space-x-2 mb-2">
            <Clock size={24} />
            <span className="text-xl font-bold">Live Event Promotions</span>
          </div>
          <p className="text-white/90">{activeEvents.length} active events • {upcomingEvents.length} upcoming • {totalProducts} products featured</p>
        </motion.div>
