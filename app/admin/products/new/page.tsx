          ...
          {({ values, setFieldValue, isSubmitting, errors, touched }) => {
            ...
            <Form className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Field
                          ...
                          className={`mt-1 ${errors.name && touched.name ? 'border-red-500' : 'border-gray-300 focus:border-primary focus:ring-primary'}`}
                        />
                      ...
                      <div>
                        ...
                        <Field
                          ...
                          className={`mt-1 ${errors.slug && touched.slug ? 'border-red-500' : 'border-gray-300 focus:border-primary focus:ring-primary'}`}
                        />
                      ...
                      <Field name="description">
                        {({ field }: any) => (
                          <RichTextEditor
                            ...
                            className={`mt-1 ${errors.description && touched.description ? 'border-red-500' : 'border-gray-300 focus:border-primary focus:ring-primary'}`}
                          />
                        )}
                      </Field>
                ...
                <Card className="border-gray-200 bg-white">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-gray-900">
                      ...
                      {videoLinks.length > 0 && (
                        <Badge variant="secondary" className="text-xs border-primary text-primary">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="video-input" className="text-sm font-medium text-gray-700">Add Video URL</Label>
                      <div className="flex space-x-2">
                        ...
                        <Button 
                          ...
                          className="px-4 bg-primary hover:bg-primary-700 text-white"
                        >
                    ...
                    {videoLinks.length > 0 && (
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <Label className="text-base font-medium text-gray-900">Video Previews ({videoLinks.length})</Label>
                          <Button
                            type="button"
                            variant="outline"
                            size="sm"
                            ...
                            >
                              ...
                              <div className="flex items-start justify-between mb-3 gap-2">
                                <div className="flex-1 min-w-0">
                                  ...
                                  <p className="text-xs text-gray-600 truncate mt-1" title={link}>
                                    {link}
                                  </p>
                                </div>
                                <Button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <Field
                          ...
                          type="number"
                          placeholder="0.00"
                          className={`mt-1 ${errors.price && touched.price ? 'border-red-500' : 'border-gray-300 focus:border-primary focus:ring-primary'}`}
                        />
                      ...
                      <div>
                        ...
                        <Field
                          ...
                          type="number"
                          placeholder="0.00"
                          className={`mt-1 ${errors.comparePrice && touched.comparePrice ? 'border-red-500' : 'border-gray-300 focus:border-primary focus:ring-primary'}`}
                        />
                      ...
                      <div>
                        ...
                        <Field
                          ...
                          type="number"
                          placeholder="0.00"
                          className={`mt-1 ${errors.cost && touched.cost ? 'border-red-500' : 'border-gray-300 focus:border-primary focus:ring-primary'}`}
                        />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Field
                          ...
                          className={`mt-1 ${errors.sku && touched.sku ? 'border-red-500' : 'border-gray-300 focus:border-primary focus:ring-primary'}`}
                        />
                    ...
                    {values.trackQuantity && (
                        ...
                        <div>
                          ...
                          <Field
                            ...
                            type="number"
                            placeholder="0"
                            className={`mt-1 ${errors.quantity && touched.quantity ? 'border-red-500' : 'border-gray-300 focus:border-primary focus:ring-primary'}`}
                          />
                          <ErrorMessage name="quantity" component="p" className="text-red-500 text-sm mt-1" />
                        </div>
                        <div>
                          <Label htmlFor="lowStockThreshold" className="text-sm font-medium text-gray-700">Low Stock Threshold</Label>
                          <Field
                            as={Input}
                      ...
                      {({ remove }) => (
                        <>
                          {values.variants.length === 0 ? (
                            <p className="text-gray-600 text-center py-4">No variants added</p>
                          ) : (
                            <div className="space-y-4">
                              {values.variants.map((variant, index) => (
                                <div key={index} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                                  ...
                                  <div>
                                    <Label className="text-sm font-medium text-gray-700">Variant Image</Label>
                                    <FileUpload
                ...
                <Card className="border-gray-200 bg-white">
                  <CardHeader>
                    <CardTitle className="text-gray-900">SEO & Meta</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                    ...
                    <div>
                      ...
                      />
                       ...
                       <div className="flex space-x-2 mt-1">
                         ...
                         />
                         <Button type="button" onClick={() => handleAddKeyword(setFieldValue)} className="bg-primary hover:bg-primary-700 text-white">Add</Button>
                       </div>
                       <div className="flex flex-wrap gap-2 mt-2">
                         {seoKeywords.map((keyword, index) => (
                           <Badge key={index} variant="secondary" className="cursor-pointer border-primary text-primary hover:bg-primary/10" onClick={() => handleRemoveKeyword(index, setFieldValue)}>
              ...
              <div className="space-y-6">
                ...
                <Card className="border-gray-200 bg-white">
                  <CardContent className="pt-6">
                    <Button type="submit" disabled={loading || isSubmitting} className="w-full bg-primary hover:bg-primary-700 text-white">
                ...
                <Card className="border-gray-200 bg-white">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="isLimitedEdition" className="text-sm font-medium text-gray-700">Limited Edition</Label>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <CardTitle className="text-gray-900">Tags</CardTitle>
                     ...
                     <div className="flex space-x-2">
                       <Input
                         ...
                         className="border-gray-300 focus:border-primary focus:ring-primary"
                       />
                       <Button type="button" onClick={() => handleAddTag(setFieldValue)} className="bg-primary hover:bg-primary-700 text-white">Add</Button>
                     </div>
                     <div className="flex flex-wrap gap-2">
                       {tags.map((tag, index) => (
                         <Badge key={index} variant="secondary" className="cursor-pointer border-primary text-primary hover:bg-primary/10" onClick={() => handleRemoveTag(index, setFieldValue)}>
                ...
                <Card className="border-gray-200 bg-white">
                  <CardHeader>
                    <CardTitle className="text-gray-900">Product Size</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex space-x-2">
                      <Input
                        ...
                        className="border-gray-300 focus:border-primary focus:ring-primary"
                      />
                      <Button type="button" onClick={() => handleAddProductSize(setFieldValue)} className="bg-primary hover:bg-primary-700 text-white">Add</Button>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      {productSize.map((size, index) => (
                        <Badge key={index} variant="secondary" className="cursor-pointer border-primary text-primary hover:bg-primary/10" onClick={() => handleRemoveProductSize(index, setFieldValue)}>
                ...
                <Card className="border-gray-200 bg-white">
                  <CardHeader>
                    <CardTitle className="text-gray-900">Shipping & Dimensions</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                ...
                <Card className="border-gray-200 bg-white">
                  <CardHeader>
                    <CardTitle className="text-gray-900">Size Reference Image</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      <Label className="text-sm font-medium text-gray-700">Size Image</Label>
                      <FileUpload
