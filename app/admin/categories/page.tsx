  ...
  const columns = [
    ...
    },
    {
      ...
      render: (value: boolean) => (
        <Badge variant={value ? "default" : "secondary"} className={value ? "bg-success-100 text-success-700" : "bg-gray-100 text-gray-600"}>
            ...
            >
              <Card className="relative overflow-hidden bg-gradient-to-br from-success-50 to-success-100 border-success-200 hover:shadow-xl transition-all duration-500">
                ...
                <CardContent className="relative p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-success-700 mb-1">Active Categories</p>
                        ...
                        <div className="flex items-center space-x-3 pt-4">
                          {dialogViewMode ? (
                            <div className="flex items-center space-x-2">
                              <Badge variant={values.isActive ? "default" : "secondary"} className={values.isActive ? "bg-success-100 text-success-700" : "bg-gray-100 text-gray-600"}>
