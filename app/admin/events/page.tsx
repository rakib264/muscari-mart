...
export default function AdminEvents() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Add CTA only if enabled and fields are filled
      if (formData.enableCta && formData.cta?.label && formData.cta?.url) {
        payload.cta = {
        ...
        payload.cta = null; // Explicitly remove CTA
      }
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-white">
            ...
            <div className="space-y-6 py-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="vertical">Vertical Banner (Grid)</SelectItem>
                    </SelectContent>
                  </Select>
                  <p className="text-xs text-gray-500 mt-1">
                    Horizontal: Full-width banner with products below. Vertical: Banner blends with products in a grid.
                  </p>
                </div>

                <div className="flex items-center justify-between border rounded-lg p-4">
                  <div className="space-y-1">
                    <Label htmlFor="showInLanding" className="text-base font-medium">Show on Home Page</Label>
                    <p className="text-sm text-gray-500">Display this event on the landing page</p>
                  </div>
                  <Switch
                    id="showInLanding"
                    checked={formData.showInLanding}
                    onCheckedChange={(checked) => setFormData({ ...formData, showInLanding: checked })}
                  />
                </div>
              </div>
              ...
              <div className="space-y-4 border-t pt-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <Label htmlFor="enableCta" className="text-base font-medium">Call-to-Action Button</Label>
                    <p className="text-sm text-gray-500">Add an optional CTA button to the event banner</p>
                  </div>
                  <Switch
                    id="enableCta"
                    checked={formData.enableCta}
                    onCheckedChange={(checked) => setFormData({ ...formData, enableCta: checked })}
                  />
                </div>
                ...
                {formData.enableCta && (
                  <div className="space-y-4 pl-4 border-l-2 border-primary-200">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setFormData({
                          ...formData,
                          cta: { ...formData.cta!, label: e.target.value }
                        })}
                    ...
                    <div>
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">
                        Use relative URLs (e.g., /products) or full URLs (e.g., https://example.com)
                      </p>
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <Switch
                        ...
                        onCheckedChange={(checked) => setFormData({
                          ...formData,
                          cta: { ...formData.cta!, openInNewTab: checked }
                        })}
                      />
                      <Label htmlFor="ctaNewTab" className="cursor-pointer">Open in new tab</Label>
                    </div>
                  </div>
                )}
              </div>
