...
export default function AdminSettings() {
  ...
  const bannerValidationSchema = Yup.object({
    ...
    discount: Yup.string().max(
      50,
      "Discount text must be less than 50 characters",
    ),
    image: Yup.string().required("Image is required"),
    ctaButtons: Yup.array()
      .of(
        Yup.object({
          label: Yup.string()
            .required("Button label is required")
            .max(30, "Button label must be less than 30 characters"),
          url: Yup.string()
            .required("Button URL is required")
            .url("Please enter a valid URL"),
        }),
      )
      .min(1, "At least one CTA button is required")
  ...
  const { showDeleteConfirmation, DeleteConfirmationComponent } =
  ...
  const bannerFormik = useFormik({
    initialValues: {
      ...
      description:
        ...
        "Discover our carefully curated collection of organic fresh food designed for healthy living",
      discount: editingBanner?.discount || "",
      image: editingBanner?.image || "",
      ctaButtons:
        editingBanner?.ctaButtons && editingBanner.ctaButtons.length > 0
          ? editingBanner.ctaButtons
          : editingBanner?.ctaButtonLabel
            ? [
                {
                  label: editingBanner.ctaButtonLabel,
                  url: editingBanner.ctaButtonUrl || "",
                },
              ]
  ...
  const saveSettings = async (type: string, data: any) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const errorData = await response.json();
        showError(
          errorData.error || `Failed to save ${type} settings`,
          "Save Failed",
        );
      ...
      onConfirm: async () => {
        try {
          ...
          if (response.ok) {
            ...
            const errorData = await response.json();
            showError(
              errorData.error || "Failed to delete banner",
              "Delete Failed",
            );
          }
        } catch (error) {
  ...
  const performBulkAction = async (
    ...
    try {
      ...
      if (response.ok) {
        ...
        const errorData = await response.json();
        showError(
          errorData.error || "Failed to perform bulk action",
          "Action Failed",
        );
      }
    } catch (error) {
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Manage your homepage carousel banners
                    </p>
                  </div>
                  <Button
                ...
                <Card>
                  <CardContent className="pt-6">
                    ...
                    {selectedBanners.length > 0 && (
                      <div className="flex items-center gap-2 mb-4 p-3 bg-info-50 rounded-lg">
                    ...
                    {totalPages > 1 && (
                      <div className="flex items-center justify-between mt-4">
                        <div className="text-sm text-gray-600">
                          ...
                          {Math.min(currentPage * 10, totalBanners)} of{" "}
          ...
          <DialogContent className="max-w-5xl max-h-[95vh] overflow-y-auto bg-white">
            <DialogHeader>
              ...
              <p className="text-gray-600">
                Design beautiful carousel banners that will captivate your
                customers
              </p>
            </DialogHeader>
            <form onSubmit={bannerFormik.handleSubmit} className="space-y-8">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="lg:col-span-2">
                      ...
                      />
                      {bannerFormik.touched.title &&
                        bannerFormik.errors.title && (
                          <p className="text-sm text-red-600 mt-1">
                            {bannerFormik.errors.title}
                          </p>
                        )}
                    ...
                    <div className="lg:col-span-2">
                      ...
                      />
                      {bannerFormik.touched.subtitle &&
                        bannerFormik.errors.subtitle && (
                          <p className="text-sm text-red-600 mt-1">
                            {bannerFormik.errors.subtitle}
                          </p>
                        )}
                    ...
                    <div className="lg:col-span-2">
                      ...
                      <Textarea
                        ...
                        onChange={bannerFormik.handleChange}
                        onBlur={bannerFormik.handleBlur}
                        placeholder="Discover our carefully curated collection of organic fresh food designed for healthy living"
                        rows={3}
                        className={`mt-2 ${bannerFormik.touched.description && bannerFormik.errors.description ? "border-red-500" : ""}`}
                      />
                      {bannerFormik.touched.description &&
                        bannerFormik.errors.description && (
                          <p className="text-sm text-red-600 mt-1">
                            {bannerFormik.errors.description}
                          </p>
                        )}
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Leave empty to hide discount badge
                      </p>
                      {bannerFormik.touched.discount &&
                        bannerFormik.errors.discount && (
                          <p className="text-sm text-red-600 mt-1">
                            {bannerFormik.errors.discount}
                          </p>
                        )}
                    ...
                    <div className="flex items-center space-x-3">
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          bannerFormik.setFieldValue("isActive", checked)
                        }
                      />
                      <div>
                        <Label
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                      ...
                      >
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              const newButtons = [
                                ...bannerFormik.values.ctaButtons,
                              ];
                              newButtons[index] = {
                                ...newButtons[index],
                          ...
                          {bannerFormik.touched.ctaButtons?.[index]?.label &&
                            ...
                            typeof bannerFormik.errors.ctaButtons[index] ===
                              "object" &&
                            "label" in
                              bannerFormik.errors.ctaButtons[index] && (
                              <p className="text-sm text-red-600 mt-1">
                                {
                                  (bannerFormik.errors.ctaButtons[index] as any)
                                    .label
                                }
                              </p>
                            )}
                          ...
                          <div className="flex space-x-2 mt-1">
                            ...
                            {bannerFormik.values.ctaButtons.length > 1 && (
                              <Button
                                ...
                                onClick={() => {
                                  const newButtons =
                                    bannerFormik.values.ctaButtons.filter(
                                      (_, i) => i !== index,
                                    );
                                  bannerFormik.setFieldValue(
                                    "ctaButtons",
                    ...
                    {bannerFormik.touched.ctaButtons &&
                      typeof bannerFormik.errors.ctaButtons === "string" && (
                        <p className="text-sm text-red-600">
                          {bannerFormik.errors.ctaButtons}
                        </p>
                      )}
                    ...
                    <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
                      ...
                      <ul className="space-y-1">
                        <li>
                          • Use action-oriented text (Order Now, Shop
                          Collection, View More)
                        </li>
                        <li>
                          • Keep labels under 20 characters for better mobile
                          display
                        </li>
                        <li>
                          • First button will be styled as primary, others as
                          secondary
                        </li>
                      </ul>
                    </div>
              ...
              <Card>
                ...
                {showLivePreview &&
                  (bannerFormik.values.title || imagePreview) && (
                    <CardContent>
                      {/* Desktop Preview */}
                      <div className="space-y-6">
                        <div>
                              ...
                              <div className="container mx-auto px-6 lg:px-8">
                                <div className="max-w-2xl">
                                  <div className="space-y-6">
                                    ...
                                    {bannerFormik.values.ctaButtons.length >
                                      0 && (
                                      <div className="flex items-center space-x-4">
                                        {bannerFormik.values.ctaButtons
                                          .slice(0, 2)
                              ...
                              <div className="absolute inset-0 flex flex-col justify-end z-10">
                                <div className="px-6 pb-16 pt-8">
                                  <div className="text-center space-y-4">
                                    ...
                                    {bannerFormik.values.ctaButtons.length >
                                      0 &&
                                      bannerFormik.values.ctaButtons[0]
                                        .label && (
                                        <div className="pt-2">
                                          <Button className="bg-white text-black hover:bg-white/90 px-6 py-2 text-sm font-medium tracking-wide uppercase border-0">
                                            {
                                              bannerFormik.values.ctaButtons[0]
                                                .label
                                            }
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="flex items-center space-x-4">
                              {(() => {
                                // Support new ctaButtons array format
                                if (
                                  previewBanner.ctaButtons &&
                                  previewBanner.ctaButtons.length > 0
                                ) {
                                  return previewBanner.ctaButtons
                                    .slice(0, 2)
                                    .map((button, index) => (
                                      <Button
                                        key={index}
        ...
        <ActionConfirmationDialog
          ...
          title={
            pendingAction === "activate"
              ? `Activate ${pendingRows.length} Banner${pendingRows.length > 1 ? "s" : ""}?`
              : `Deactivate ${pendingRows.length} Banner${pendingRows.length > 1 ? "s" : ""}?`
          }
          description={
            pendingAction === "activate"
              ? "Selected banners will become active and visible to customers on your homepage carousel."
              : "Selected banners will be deactivated and hidden from customers. They will be removed from the current list."
          }
          confirmLabel={
