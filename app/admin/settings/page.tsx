...
import MuscariMartLogo from "@/lib/assets/images/wellrise.png"
...
export default function AdminSettings() {
  ...
  const bannerFormik = useFormik({
    initialValues: {
      ...
      description: editingBanner?.description || 'Discover our carefully curated collection of organic fresh food designed for healthy living',
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="p-4 bg-info-50 border border-info-200 rounded-lg">
                    <h5 className="font-medium text-info-800 mb-2">ZamanIT SMS Configuration:</h5>
