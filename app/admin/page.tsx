  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        {/* Header */}
        <div className="relative overflow-hidden rounded-xl border border-gray-200 p-4 md:p-6 shadow-sm bg-white">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
              <div>
                ...
                <div className="mt-2 flex flex-wrap items-center gap-2">
                  ...
                  <span className="inline-flex items-center rounded-full bg-gray-100 px-2.5 py-1 text-xs font-medium text-gray-700 border border-gray-200">
                    {formatDate(now)}
                  </span>
                </div>
              </div>
              <motion.div
                ...
                className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white/90 backdrop-blur px-3 py-1.5 shadow-sm"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="border-gray-200 bg-white">
            <CardHeader>
              <CardTitle className="text-gray-900">Product Sales by Category</CardTitle>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                  ...
                  <div key={product._id} className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">{product.totalSales} sales</p>
                      </div>
                    </div>
                    <div className="text-right">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                {(data?.widgets.highValueCustomers || []).slice(0, 5).map((customer) => (
                  <div key={customer._id} className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">{customer.customer.email}</p>
                      </div>
                    </div>
